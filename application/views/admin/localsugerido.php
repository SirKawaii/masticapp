                ...
                <form>
                    ...
                    <div class="col s12 l12 m12">
                        ...
                        <div class="input-field col s12">
                            ...
                            <input value="<?= $local->lat;?>" id="lat" type="text" class="validate" disabled>
                        </div>
                        <div class="input-field col s12">
                            <i class="material-icons prefix">location_on</i>
                            <input value="<?= $local->lng;?>" id="lng" type="text" class="validate" disabled>
                        </div>
                    </div>
                    </div>
                </form>
        ...
        <div class="card row">
            ...
            <div class="col s12 l12 m12">
                <form name="subir_imagen" id="subir_imagen" >
                    <p>Imagen:</p>
                    <img class="responsive-img" src="<? if ($local->imagen != ""){echo $local->imagen;}else{echo base_url('assets/imagenes/404.png');} ?>">
            ...
            <div class="col s12 l12 m12">
                <a class="waves-effect waves-light btn" id="mod_local"><i class="material-icons right">send</i>Agregar sugerencia Local</a>
                <br><br>
            </div>
...
function sendData(id)
{
    ...
    Materialize.toast('Subiendo Imagen, no cierres la ventana.', 3000);
     ...
     $.ajax({
            type:"POST",
            url:"<?php echo base_url('sugerencias/subir/');?>",
            data:data,
...
function nuevos_datos(imagen){
    if(imagen == ""){
        var imagen = "<? echo $local->imagen;?>";
    }

    var id = '<?= $local->id_local; ?>';
...
$.ajax({
            url:"<?= base_url('sugerencias/actualiza_local/');?>",
            type:"POST",
            data:{
                  id:id,
                  nombre:nombre,
